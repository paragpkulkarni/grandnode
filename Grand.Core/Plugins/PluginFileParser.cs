...
namespace Grand.Core.Plugins
{
    ...
    public static class PluginFileParser
    {
        ...
        public static PluginDescriptor PreparePluginDescription(FileInfo fileinfo)
        {
            ...
            descriptor.SupportedVersion = pluginInfo.SupportedVersion;
            descriptor.Author = pluginInfo.Author;
            descriptor.PluginFileName = pluginInfo.FileName;

            var cfgfile = Path.Combine(fileinfo.Directory.FullName, "config.cfg");
